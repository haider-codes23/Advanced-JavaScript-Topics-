// - What if we want to have the flexibility to pass in as many arguments as we want to a function call e..g in the sum function below how can we implement that ? Every function in JS have a special object called arguments. IF we log it to the console, we can see that it looks like an array, but it is not, it is an object. But the keys we have in this object are the index of arguments passed to this function.
